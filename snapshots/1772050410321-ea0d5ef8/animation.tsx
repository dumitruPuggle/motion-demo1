...
/**
 * NOTE:
 * You asked to retry the previous request (replace the whole animation),
 * but the target replacement component code is still not included.
 *
 * Please paste the full TSX for the component you want here, or provide:
 * - component name
 * - file path
 * - any props it requires
 * and I will replace this entire file accordingly.
 */
