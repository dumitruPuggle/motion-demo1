...
// -----------------------------------------------------------------------------
// Referenced Component: AgentCard (SimpleRagAgentCard)
// NOTE: This is included verbatim in spirit (structure/style) based on the
// provided reference. It is not rendered by default in AssistantLanding.
// -----------------------------------------------------------------------------
...
const IconBuilding: React.FC<IconProps> = ({
	...
	return (
		<IconSvg size={size}>
			<path
				d="M4.5 20.5V5.6c0-.7.55-1.25 1.25-1.25h6c.7 0 1.25.55 1.25 1.25v14.9h-8.5Zm10 0V9.1c0-.7.55-1.25 1.25-1.25h2.5c.7 0 1.25.55 1.25 1.25v11.4H14.5Z"
				fill={color}
				opacity={0.95}
			/>
			<path
				d="M7 8h4M7 11h4M7 14h4M7 17h4"
				stroke={color}
				strokeWidth={1.6}
				strokeLinecap="round"
				opacity={0.8}
...
const MetaItem: React.FC<{icon: React.ReactNode; text: string}> = ({
	icon,
	text,
}) => {
	return (
	...
	return (
		<div
			style={{
				...
				inset: 0,
				background:
					"radial-gradient(800px 500px at 20% 5%, rgba(122,77,255,0.28) 0%, rgba(0,0,0,0) 60%), radial-gradient(700px 480px at 90% 20%, rgba(215,176,96,0.14) 0%, rgba(0,0,0,0) 62%)",
				opacity: 0.9,
				pointerEvents: "none",
			}}
		/>
		...
		<>
			<div
				style={{
					...
					borderRadius: 24,
					background:
						"linear-gradient(180deg, rgba(122,77,255,0.35) 0%, rgba(122,77,255,0.10) 100%)",
					border: "1px solid rgba(255,255,255,0.08)",
